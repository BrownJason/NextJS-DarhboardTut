...
export default async function InvoicesTable({ query, currentPage, invoiceCount }: { query: string; currentPage: number; invoiceCount: number }) {
  const invoices = await fetchFilteredInvoices(query, currentPage, invoiceCount);
        ...
        <div className="rounded-lg bg-gray-50 p-2 md:pt-0 dark:bg-gray-600">
          <div className="md:hidden">
            {invoices?.map((invoice) => (
              <div key={invoice.id} className="mb-2 w-full rounded-md bg-white p-4 dark:bg-gray-600">
